...
bool ActionDefinition::isDigital() const
{
    return m_isDigital;
}

const QString &ActionDefinition::name() const
{
    return m_name;
}

const QString &ActionDefinition::type() const
{
    return m_type;
}

const QString &ActionDefinition::actionSet() const
{
    return m_actionSet;
}
