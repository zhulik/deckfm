...
struct ControllerInfo {
  ...
  bool operator==(const ControllerInfo &other) { return handle == other.handle; }
};
...
struct DigitalAction {
  ...
  bool operator==(const DigitalAction &other) { return handle == other.handle; }
};
...
struct AnalogAction {
  ...
  bool operator==(const AnalogAction &other) { return handle == other.handle; }
};
